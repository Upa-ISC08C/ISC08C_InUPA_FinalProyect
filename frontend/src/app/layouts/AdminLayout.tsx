      ...
      <div className="px-3 py-4 border-t border-white/10 space-y-1">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-white truncate">Admin UPA</p>
            <p className="text-xs text-white/40 truncate">admin@upa.edu.mx</p>
          </div>
        </div>
        <Link
          to="/"
          className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm text-white/45 hover:text-white hover:bg-white/[0.06] transition-all"
        >
