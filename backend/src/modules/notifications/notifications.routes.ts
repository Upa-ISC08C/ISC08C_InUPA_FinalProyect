...
router.get('/', validate(notificationFiltersSchema), asyncHandler(NotificationsController.listar));
...
router.patch('/:id/read', validate(notificationIdParamsSchema), asyncHandler(NotificationsController.marcarLeida));
